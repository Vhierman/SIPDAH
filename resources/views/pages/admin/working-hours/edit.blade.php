        ...
        <main>
            <div class="container-fluid mt-4">
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active">Edit Jam Kerja {{ $item->jam_masuk }}</li>
                </ol>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('working-hours.update', $item->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="jam_masuk"
                                        placeholder="Masukan Jam Masuk" value="{{ $item->jam_masuk }}">
                                    <label for="title" class="form-label">Jam Pulang</label>
                                    <input type="text" class="form-control" name="jam_pulang"
                                        placeholder="Masukan Jam Pulang" value="{{ $item->jam_pulang }}">
