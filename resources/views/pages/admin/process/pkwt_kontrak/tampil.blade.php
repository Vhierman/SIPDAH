        ...
        <main>
            <div class="container-fluid mt-4">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('process.prosess_pkwt_kontrak', $akhir_kontrak) }}" method="POST"
                            class="d-inline">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-grid gap-2 mt-3">
                                    ...
                                    <a href="{{ route('process.process_pkwt_kontrak') }}"
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        Data PKWT Kontrak Habis Tanggal {{ \Carbon\Carbon::parse($akhir_kontrak)->isoformat('D MMMM Y') }}
                    </div>
                    <div class="card-body">
