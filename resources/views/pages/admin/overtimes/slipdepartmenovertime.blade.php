            ...
            <div class="container-fluid mt-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('overtimes.hasil_slipdepartment_overtime') }}" target="_blank"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <select name="divisions_id" class="form-select">
                                            ...
                                            <option value="Warehouse"
                                                @if (old('divisions_id') == 'Warehouse') {{ 'selected' }} @endif>Warehouse
                                            </option>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <select name="status_kerja" class="form-select">
                                            ...
                                            <option value="PKWTT"
                                                @if (old('status_kerja') == 'PKWTT') {{ 'selected' }} @endif>Tetap
                                            </option>
                                            <option value="PKWT"
