        ...
        <main>
            <div class="container-fluid mt-4">
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active">Edit Penempatan {{ $item->penempatan }}</li>
                </ol>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('divisions.update', $item->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="penempatan"
                                        placeholder="Masukan Nama Penempatan" value="{{ $item->penempatan }}">
